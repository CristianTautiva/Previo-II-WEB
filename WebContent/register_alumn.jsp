        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              <h3 class="login-heading mb-4">Registro de Alumnos</h3>
              <form action="register_alumn" method="post">
                <div class="form-label-group">
                  <input type="text" id="inputCodigo" name="codigo" class="form-control" placeholder="Codigo" required autofocus>
